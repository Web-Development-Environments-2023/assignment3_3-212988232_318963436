  ...
  <div class="center">
    <div class="card" style="width: 50rem;">
      ...
      <div class="card-body">
        ...
        <ul >
          <li>
            <img src="../assets/clock_black.png" height="25px" width="25px"> {{ this.readyInMinutes }}      
          </li>

          <li>
            <img src="../assets/servings_black.png" height="25px" width="25px"> {{ this.servings }}
          </li>
        </ul>
          <ul>
          <li v-if="this.vegan">
        ...
        <tr>
          ...
          <tr v-for="ingredient in this.ingredients" :key="ingredient.id">
            ...
            <td>
           <h5> {{ ingredient.amount.us.value }}   {{ ingredient.amount.us.unit }}</h5> 
